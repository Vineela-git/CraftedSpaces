...
import { FaFacebookF,  FaLinkedin, FaEnvelopeOpen} from "react-icons/fa";
                        ...
                        <div className="col-xl-6 col-lg-5">
                            <div className="footer-widget border-end">
                                <div className="footer-newsletter">
                                    ...
                                    <p>To inquire further, leave your email address below and subscribe for updates.</p>
                                    <form>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="footer-copyright">
                                <span className="copyright-text">© {new Date().getFullYear()}. All rights reserved by Crafted Spaces.</span>
                            </div>
                        </div>
                        <div className="col-md-6">
